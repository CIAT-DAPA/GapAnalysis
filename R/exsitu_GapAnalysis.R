...
exsitu_GapAnalysis <- function(species_list, occurrenceData, raster_list, bufferDistance,ecoReg){
  # call SRSex
  srsEx <- gapAnalysisR::srs_Exsitu(species_list = species_list,
  ...
  # call FCSex
  fcsEx <- gapAnalysisR::fcs_Exsitu(srsEx,grsEx,ersEx)
